...
export default function Section({
  ...
  const surfaceClass = surface === "surf2" ? "bg-[color:var(--surf2)]" : "bg-[color:var(--surf1)]";
  return (
    <section
      id={id}
      className={`mx-auto mt-8 max-w-6xl scroll-mt-24 rounded-2xl border border-[color:var(--border)] px-6 py-12 ${surfaceClass} ${className || ""}`}
    >
